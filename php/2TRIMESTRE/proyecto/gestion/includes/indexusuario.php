    ...
    <div class="container">
        <form action="user_page.php" method="post">
            <div class="from-group text-center">
                <button type="submit" class="btn btn-primary btn-lg" style="background-color: #2e86de;">¡Al lío!</button>
            </div>
        </form>
        <form action="login.php" method="post">
            <div class="from-group text-center">
                <button type="submit" class="btn btn-primary btn-lg" style="background-color: #6c757d;">Volver al Login</button>
            </div>
        </form>
    </div>
</div>
